...
struct TAlarmsManager  {
    TAlarmStatus AlarmsStatus[50];
    bit PackedAlarmsStatus[64];
    bit BuzzerReq;
    bit AlarmR;
    bit WarningR;
...
TParamsField ParamField[213];
TMask MaskParams[136];
TUnit UnitTab[15];
;
;
;
...
struct TEXD316: object  {
    signed long LastError;
    unsigned short RemoteID;
    signed char ID;
    bit Restarted;
    signed short AlarmStatus;
    void Init();
    signed long NoConnection();
    void Run();
    signed long GetDI(signed char iIndex);
    signed long GetAI(signed char iIndex);
    signed long SetAIType(signed char iIndex, signed char iType, signed long iParam);
    signed long GetAIType(signed char iIndex);
    signed long ReadParam(unsigned char iIndex);
    void WriteParam(unsigned char iIndex, signed long iValue);
    signed long GetValvePos();
    void SetManualMode(signed long iMode);
    void SetManualVPos(signed long iValvePos);
    signed long GetManualVPos();
    signed long GetValvePosEx();
    void SetManualVPosEx(signed long iValvePos);
    signed long GetAlarmStatus(signed long iAlarmID);
    void SetValveType(signed long iValveType, signed long iSteps, signed long iSpeed, signed long iCurrent);
};
struct TEXD316_G: TEXD316  {
    TEXD316 super;
    signed char ServerID;
    signed short EXDValue[12];
    unsigned char read_idx;
    void Run();
};
void DrawFormEXD316Debug_G(TEXD316_G exd, signed long iAllowManual);
;
;
;
;
...
signed short EventHistoryLog_EventID[6];
signed long EventHistoryLog_StartEvent[6];
signed long EventHistoryLog_EndEvent[6];
...
struct T7dScheduledAction  {
    ...
    void SetSchedule(signed char iHour, signed char iMin, signed char iMonth, signed char iDay, signed char iWeekDays, unsigned char iAction, unsigned char iGroup);
    void Clear();
...
struct T7dScheduler  {
    ...
    signed char TriggeredGroup;
    void Init();
    signed long CheckNextAction(TDateTime d);
    signed long CheckNextActionNow(TDateTime d, signed char Group);
    void Clear();
};
void DrawFormScheduler(signed char iAllowEdit);
struct T7dScheduleUIGraph  {
    T7dScheduledAction schedule;
    signed long ScheduleDataGroup[20];
    unsigned char FreeProgramPointer[20];
    unsigned char SchedulePointerGroup[20];
    unsigned char NewSchedulePointerGroup[20];
    unsigned char NewScheduleTime[20];
    unsigned char NewScheduleAction[20];
    unsigned char NewAction;
    unsigned char WeekDays;
    signed short LastDirection;
    unsigned char LastEditField;
    unsigned char NewScheduleIndex;
    unsigned char DayIndex;
    signed char LastLoadedGroup;
    unsigned char NumGroupProgram;
    unsigned char NumFreeProgram;
    signed char SelectedAction;
    signed char LastAction;
    signed char EditField;
    unsigned char val;
    unsigned char min;
    void Init();
    void ClearAllData();
    void ClearGroupData(signed char GroupId);
    void ClearDaysGroupData(signed char iGroup, unsigned char iWeekDays);
    void ClearNewData();
    void LoadData();
    void DrawFormPercentage(signed short action, signed short maxAction);
    void AnalyzeData(signed char Group);
    void SortPointer(signed char Group);
    void bubbleSort();
    void swap(signed short one, signed short two);
    void DrawForm(signed char iAllowEdit, signed char Group, signed char Edit, signed char yHeight);
    void DrawFormGraph7dScheduledAction(unsigned char Day, signed char StY, signed char Edit, signed char Group, signed char Action, signed long Sec);
    void Draw_TimeLine(signed char OfX, signed char OfY, signed char StY, signed char Len, signed short PrevActionTime, signed short ThisActionTime, unsigned char PrevAction, unsigned char ThisAction, unsigned char ActionNum);
    void Draw_Immage();
};
signed char Checkgroup;
;
;
signed long ScheduledAction[20];
